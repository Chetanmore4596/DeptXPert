                ...
                <nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
                    ...
                    <div class="collapse navbar-collapse" id="navbarCollapse">
                        <div class="navbar-nav mx-auto py-0">
                            <a href="Student.php" class="nav-item nav-link active">Home</a>
                            <a href="Game/quiz/quiz.php" class="nav-item nav-link" >Quiz Games</a>
                            <a href="Lectures/Lectures.php" class="nav-item nav-link">Lectures+Book</a>
                            <a href="Study/index.php" class="nav-item nav-link">Study</a>
                            <a href="https://daily.dev/" class="nav-item nav-link">Tech updates</a>
                            <a href="Prompt.php" class="nav-item nav-link">Parent</a>
                            <a href="#About-on" class="nav-item nav-link">About</a>
                            <a href="#contact-on" class="nav-item nav-link">Contact</a>
                        </div>
                        <a href="studlogout.php" class="btn rounded-pill py-2 px-4 ms-3 d-none d-lg-block">Logout</a>
                    </div>
                </nav>
                ...
                <div class="container py-5 px-lg-5">
                    <div class="row g-5 align-items-center">
                        <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                            ...
                            <h1 class="mb-5">Computer Engineering Student's Strength</h1>
                        ...
                        <div class="col-lg-6">
                            <img class="img-fluid wow zoomIn" data-wow-delay="0.5s" src="CO.png">
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row g-4">
                        <div class="col-lg-4 wow fadeInUp" data-wow-delay="0.1s">
                            <div class="feature-item bg-light rounded text-center p-4">
                                ...
                                <h5 class="mb-3">Game</h5>
                                <a href="Game\quiz\quiz.html">Click to go Quiz Games.</a>
                            </div>
                        </div>
                        <div class="col-lg-4 wow fadeInUp" data-wow-delay="0.3s">
                            <div class="feature-item bg-light rounded text-center p-4">
                                ...
                                <a href="Student_Info/Studentdata.php">Click to go Book.</a>
                            </div>
                        </div>
                        <div class="col-lg-4 wow fadeInUp" data-wow-delay="0.5s">
                            <div class="feature-item bg-light rounded text-center p-4">
                                ...
                                <a href="file_upload_download/index.php">Click to go Study.</a>
                            </div>
                        </div>
                    </div>
                </div>
