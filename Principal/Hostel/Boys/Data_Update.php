    ...
    <div class="container rounded bg-white mt-5 mb-3">
        ...
        <div class="row">
            <div class="col-md-2 border-right">
                <a href="https://deptxpert.com/DeptXPert/Hostel/Boys/Boys.php" class="btn btn-info profile-button " type="button"><i class="bi bi-arrow-left-circle"></i>&nbsp;&nbsp;Back</a>
            ...
            <div class="col-md-10">
                <div class="p-5 py-10">
                    ...
                    <div class="row mt-2">
                        ...
                        <div class="col-md-6"><label class="labels">Gender :</label><input type="number" class="form-control" readonly="true" placeholder="Male" required></div>
                        </div>
