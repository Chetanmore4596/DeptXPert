        ...
        <div class="row mt-5">
          <div class="col">
            <div class="card mt-5">
              ...
              <a href="https://deptxpert.com/DeptXPert/Hostel/Girls/Girls.php" class="btn btn-info profile-button " type="button"><i class="bi bi-arrow-left-circle"></i>&nbsp;&nbsp;Back</a>
                ...
                <div class="card-body bg-info">
                    <table class="table table-bordered text-center text-white">
                        ...
                        <?php 
                            ...
                            $sql="SELECT * FROM boys WHERE UName LIKE '%$Name%'";
