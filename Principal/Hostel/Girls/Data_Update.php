    ...
    <div class="container rounded bg-white mt-5 mb-3">
        ...
        <div class="row">
            <div class="col-md-2 border-right">
                <a href="https://deptxpert.com/DeptXPert/Principal/Hostel/Girls/Girls.php" class="btn btn-info profile-button " type="button"><i class="bi bi-arrow-left-circle"></i>&nbsp;&nbsp;Back</a>
                ...
                <span class="font-weight-bold">Hostel</span><span class="text-black-50">Hostel@gmail.com</span><span> </span></div>
            </div>
            <div class="col-md-10">
                <div class="p-5 py-10">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <h4 class="text-right">Hostel Student record Insert</h4>
                    </div>
                    <div class="row mt-2">
                    <div class="col-md-6"><label class="labels">Student_id :</label><input type="number" class="form-control"  name="Student_id" required></div>
                    <div class="col-md-6"><label class="labels">Full Name :</label><input type="text" class="form-control" name="Name" required></div>
                    <div class="col-md-6"><label class="labels">Paid Fee :</label><input type="number" class="form-control"  name="PaidFee" required></div>
                    </div>
                    <div class="row mt-2">
                        <div class="col-md-6 mt-md-3 mt-3">
                        <div class="col-md-6"><label class="labels">Gender :</label><input type="number" class="form-control" readonly="true" placeholder="Female" required></div>
                        </div>
                        <div class="col-md-6"><label class="labels">Branch :</label>
                            <select class="form-control" name="Branch" required>
                                <option value="" name="Branch">None</option>
                                <option value="Computer Engineering" name="Branch">Computer Engineering</option>
                                ...
                                <option value="Electronic Engineering" name="Branch">Electronic Engineering</option>
                            </select>
                        </div>
