        ...
        <div class="row mt-5">
          <div class="col">
            <div class="card mt-5">
              ...
              <button onclick="window.print()" class="btn btn-info profile-button "><i class="bi bi-printer"></i>&nbsp;&nbsp;Print</button>
              ...
              <div class="mx-auto bg-info" style="width:99%;">&nbsp;&nbsp;
                        ...
                        <a href="Teacher_data_insert.php"class="btn btn-warning my-3" type="button">ADD&nbsp;&nbsp;<i class="bi bi-plus-circle"></i></a>
                </form>
                    ...
                    <table class="table table-bordered text-center text-white">
                        ...
                        <?php 
                            ...
                            if ($result->num_rows > 0) {
                                ...
                                <td><?php echo $row['Registor_Date']; ?></td>
                                <td><a href="Teacher_Update.php?id=<?php echo $row['id']; ?>" class="btn btn-warning">Edit&nbsp;&nbsp;<i class="bi bi-pencil-square"></i></a></td>  
