            ...
            <div class="col-md-10">
                <div class="p-5 py-10">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <h4 class="text-right">Teacher record Update</h4>
                    </div>
                    <div class="row mt-2">
                        <div class="col-md-6"><label class="labels">Teacher ID :</label><input type="number" class="form-control" name="Teacher_id" required></div>
                        <div class="col-md-6"><label class="labels">Full Name :</label><input type="text" class="form-control" name="Name" required></div>
                        <div class="col-md-6"><label class="labels">Email :</label><input type="text" class="form-control" name="Email" required></div>
                    </div>
                    <div class="row mt-2">
                        <div class="col-md-6"><label class="labels">Mobile_no :</label><input type="number" class="form-control"  name="Mobile_no" maxlength="10" pattern="\d{10}" required></div>
                        ...
                        <div class="col-md-6 mt-md-3 mt-3">
                            <div class="m-flex align-items-center mt-2">
                                <label>Class :</label>
                                    <label class="option">
                                    <input type="radio" value="FY" name="Class" required><label>FY&nbsp;&nbsp;</label>
                                    </label>
                                    <label class="option ms-4">
                                    <input type="radio" value="SY" name="Class" required><label>SY&nbsp;&nbsp;</label>
                                    </label>
                                    <label class="option">
                                    <input type="radio" value="TY" name="Class" required><label>TY&nbsp;&nbsp;</label>
                                    </label>
                            </div>
                        </div>
                        <div class="col-md-6"><label class="labels">Subject :</label><input type="text" class="form-control" name="Sub" required></div>
                    </div>
                    <div class="mt-5 text-center"><button class="btn btn-primary profile-button" type="submit">Update&nbsp;&nbsp;<i class="bi bi-floppy"></i></button></div>
                </div>
            </div>
        </div>
    </div>
