          ...
          <div class="col">
            <div class="card mt-5">
              ...
              <div class="mx-auto bg-info" style="width:99%;">&nbsp;&nbsp;
                        ...
                        <a href="Student_data_insert.php"class="btn btn-warning my-3" type="button">ADD&nbsp;&nbsp;<i class="bi bi-plus-circle"></i></a>
                </form>
                        ...
                        <?php 
                            ...
                            if ($result->num_rows > 0) {
                                ...
                                <tr>
                                    ...
                                    <td><a href="Student_Update.php?id=<?php echo $row['id']; ?>" class="btn btn-warning">Edit&nbsp;&nbsp;<i class="bi bi-pencil-square"></i></a></td>  
