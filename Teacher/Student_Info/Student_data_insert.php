...
<body class="bg-dark">
    ...
    <form action="Student_record_insert.php" method="post">
    ...
    <?php
        ...
        <div class="row">
            <div class="col-md-2 border-right">
                ...
                <span class="font-weight-bold">UTI</span><span class="text-black-50">uti@gmail.com</span><span> </span></div>
            </div>
            <div class="col-md-10">
                <div class="p-5 py-10">
                    ...
                    <div class="row mt-2">
                        ...
                        <div class="col-md-6"><label class="labels">Test :</label><input type="text" class="form-control" name="Test" min="0" max="10" required></div>
